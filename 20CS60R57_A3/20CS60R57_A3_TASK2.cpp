...
public:
    ...
    void AddToWait(custEvent Event)
    {
        ...
        // insert element at the rear
            ...
            REGQueue[0] = Event;
            }else if(Event.package == 6){
                int i;
                for(i = 0;i<rearQ;i++){
                    if(REGQueue[i].package!=1)
                        break;
                }
                for (int j = rearQ; j >i; j--) {
                    REGQueue[j] = REGQueue[j - 1];
                }
                REGQueue[i] = Event;
            }else{
    ...
    void AddToWaitECG(custEvent Event)
    {
        ...
        // insert element at the rear
            ...
            ECGQueue[0] = Event;
                ...
                int i;
                for(i = 0;i<rearECG;i++){
                    if(ECGQueue[i].package!=1)
                        break;
                }
                for (int j = rearECG; j >i; j--) {
                    ECGQueue[j] = ECGQueue[j - 1];
                }
                ECGQueue[i] = Event;
            }else{
...
public:
    ...
    void AddToWaitECHO(custEvent Event)
    {
        ...
        // insert element at the rear
            ...
            if(Event.package==1){
                for (int i = rearECHO; i >0; i--) {
                    ECHOQueue[i] = ECHOQueue[i - 1];
            }
            ECHOQueue[0] = Event;
            }else if(Event.package == 6){
                int i;
                for(i = 0;i<rearECHO;i++){
                    if(ECHOQueue[i].package!=1)
                        break;
                }
                for (int j = rearECHO; j >i; j--) {
                    ECHOQueue[j] = ECHOQueue[j - 1];
                }
                ECHOQueue[i] = Event;
            }else{
    ...
    void AddToWaitTM(custEvent Event)
    {
        ...
        // insert element at the rear
            ...
            TMQueue[0] = Event;
                ...
                int i;
                for(i = 0;i<rearTM;i++){
                    if(TMQueue[i].package!=1)
                        break;
                }
                for (int j = rearTM; j >i; j--) {
                    TMQueue[j] = TMQueue[j - 1];
                }
                TMQueue[i] = Event;
            }else{
    ...
    void AddToWaitMRI(custEvent Event)
    {
        ...
        // insert element at the rear
            ...
            MRIQueue[0] = Event;
                ...
                int i;
                for(i = 0;i<rearMRI;i++){
                    if(MRIQueue[i].package!=1)
                        break;
                }
                for (int j = rearMRI; j >i; j--) {
                    MRIQueue[j] = MRIQueue[j - 1];
                }
                MRIQueue[i] = Event;
            }else{
    ...
    void AddToWaitCT(custEvent Event)
    {
        ...
        // insert element at the rear
            ...
            CTQueue[0] = Event;
                ...
                int i;
                for(i = 0;i<rearCT;i++){
                    if(CTQueue[i].package!=1)
                        break;
                }
                for (int j = rearCT; j >i; j--) {
                    CTQueue[j] = CTQueue[j - 1];
                }
                CTQueue[i] = Event;
            }else{
